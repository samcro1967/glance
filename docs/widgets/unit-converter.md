...
The widget has no required configuration properties beyond the standard [shared widget properties](../widgets.md#shared-properties). Each category provides default source and destination units, which can be changed interactively in the widget.


---

[Widgets](../widgets.md) · [Configuration](../configuration.md) · [Back to top](#unit-converter)
