...
- **Widget refresh synchronization** — Synchronizes refreshes per widget to prevent duplicate concurrent updates while preserving parallel refreshes across different widgets.
