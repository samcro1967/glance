...
* Fork widgets including ICS Events, Timer, Stopwatch, Torrenting, ARR, Seerr, Latest Media, Unit Converter, Calculator, Analog Clock, Status Bar, and additional layout and utility components
