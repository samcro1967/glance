...
* Fork widgets including ICS Events, Timer, Stopwatch, Torrenting, ARR, Seerr, Latest Media, Media History, Unit Converter, Calculator, Analog Clock, Status Bar, and additional layout and utility components
